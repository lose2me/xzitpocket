...
abstract final class AppTheme {
  static final light = _build(
    ...
    colors: FColors.neutralLight.copyWith(
      ...
      secondary: const Color(0xFFE8F1EE),
      secondaryForeground: const Color(0xFF183B32),
  ...
  static final dark = _build(
    ...
    colors: FColors.neutralDark.copyWith(
      ...
      primary: const Color(0xFF65C9EA),
      primaryForeground: const Color(0xFF06252F),
      secondary: const Color(0xFF1C302A),
      secondaryForeground: const Color(0xFFDDF2E9),
